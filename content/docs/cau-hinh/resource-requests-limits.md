...
- [Tổng quan](#tổng-quan)
- [1. Hai quyết định khác nhau: chọn Node và giới hạn runtime](#1-hai-quyết-định-khác-nhau-chọn-node-và-giới-hạn-runtime)
- [2. CPU](#2-cpu)
- [3. Memory](#3-memory)
...
## 1. Hai quyết định khác nhau: chọn Node và giới hạn runtime
...
Cơ chế native sidecar làm một số init container tiếp tục chạy cùng app; cách tính phức tạp hơn vì phải cộng các container chạy đồng thời tại từng phase. Dùng `kubectl describe pod` và scheduler docs/version cụ thể để xác minh effective requests.
